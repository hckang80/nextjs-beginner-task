...
export const announcementStepsLabel = announcementSteps.map(
  ({ label }) => label
);
...
export const announcementTypesLabel = announcementTypes.map(
  ({ label }) => label
);
...
export const announcementPricesLabel = announcementPrices.map(
  ({ label }) => label
);
